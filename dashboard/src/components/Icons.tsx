...
export function CampañasIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
...
export function PSRIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
      <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zm-9.5-3.5l1.41 1.41L12 15.33l2.09 2.09 1.41-1.41L13.41 14l2.09-2.09-1.41-1.41L12 12.67l-2.09-2.09-1.41 1.41L10.59 14l-2.09 2.09z" />
    </SvgIcon>
  );
}

export function AveriasIcon(props: IconProps) {
  return (
    <SvgIcon {...props}>
